...
const baseFoodLibrary = [
  { name: "Whole Eggs", serving: 100, unit: "g", cals: 143, p: 13.0, c: 0.7, f: 9.9, isBase: true },
  { name: "Chicken Breast (Cooked)", serving: 100, unit: "g", cals: 165, p: 31.0, c: 0.0, f: 3.6, isBase: true },
  { name: "White Rice (Cooked)", serving: 150, unit: "g", cals: 195, p: 4.1, c: 43.0, f: 0.4, isBase: true },
  { name: "Egg Whites", serving: 100, unit: "g", cals: 52, p: 11.0, c: 0.7, f: 0.2, isBase: true },
  { name: "Oatmeal (Dry)", serving: 50, unit: "g", cals: 190, p: 6.5, c: 34.0, f: 3.5, isBase: true },
  { name: "Whey Protein Isolate", serving: 30, unit: "g", cals: 120, p: 25.0, c: 1.5, f: 1.0, isBase: true },
  { name: "Greek / Plain Yogurt", serving: 150, unit: "g", cals: 90, p: 15.0, c: 5.0, f: 0.5, isBase: true },
  { name: "Canned Tuna (Drained)", serving: 120, unit: "g", cals: 130, p: 29.0, c: 0.0, f: 1.0, isBase: true },
  { name: "Pasta (Dry)", serving: 80, unit: "g", cals: 280, p: 10.0, c: 58.0, f: 1.2, isBase: true },
  { name: "Olive Oil", serving: 14, unit: "g", cals: 120, p: 0.0, c: 0.0, f: 14.0, isBase: true },
  { name: "Peanut Butter", serving: 32, unit: "g", cals: 190, p: 8.0, c: 7.0, f: 16.0, isBase: true },
  { name: "Banana", serving: 118, unit: "g", cals: 105, p: 1.3, c: 27.0, f: 0.3, isBase: true }
];
...
style.textContent = `
  ...
  .ntr-modal-box { background: #18181b; border: 1px solid #3f3f46; border-radius: 12px; padding: 18px; width: 92%; max-width: 480px; box-shadow: 0 16px 45px rgba(0,0,0,0.9); max-height: 90vh; overflow-y: auto; }
...
function renderMacroTracker() {
  ...
  container.innerHTML = `
    ...
    <div class="ntr-goals-widget">
      ...
      <button class="ntr-btn-edit-goals" id="btn-open-goals-modal">⚙️ Edit Goals</button>
    </div>
    ...
    <!-- 4. LOG FOOD ITEM MODAL (SEARCH & SCALE) -->
    ...
    <!-- 5. FOOD LIBRARY BROWSING & MANAGER MODAL -->
    <div class="ntr-modal-overlay" id="food-library-modal">
      <div class="ntr-modal-box">
        ...
        <div style="font-size:0.72rem; color:#94a3b8; margin-bottom:8px;">Click any food item below to select and log it to your day:</div>
    ...
    <div class="ntr-modal-overlay" id="custom-food-modal">
      <div class="ntr-modal-box">
        ...
        <div style="font-size:0.75rem; color:#a1a1aa; margin-bottom:10px;">Values per standard serving (e.g. 100g or 1 pack). This item will appear in your food library permanently.</div>
        
        <input type="text" class="ntr-modal-input" id="cf-name" placeholder="Food Name (e.g. Soummam Yogurt 0%)" />
  ...
  container.querySelector("#btn-save-permanent-cf").onclick = async () => {
    ...
    const newFood = { name, serving: serv, unit, cals, p, f, c, isBase: false };
...
renderMacroTracker();
  ...
  dv.paragraph("❌ **Macro Tracker Error:** " + err.message);
}
}
