```dataviewjs
// =============================================================
// 1. ASYNC RESOURCE LOADER (soma-data.json & muscleRegistry.json)
// =============================================================
...
// =============================================================
// 2. BIOMECHANICS DATABASE & MUSCLE REGISTRY BRIDGE
// =============================================================
const exerciseDB = [
  // CHEST
  { name: "Incline Dumbbell Press", muscle: "Chest", subTarget: "Upper Pec (Clavicular)", registryKey: "chest", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Incline Barbell Bench", muscle: "Chest", subTarget: "Upper Pec (Clavicular)", registryKey: "chest", hours: 48, position: "Mid-Range", risk: "Moderate 🟡", tier: "A-Tier" },
  { name: "Smith Machine Incline Press", muscle: "Chest", subTarget: "Upper Pec (Clavicular)", registryKey: "chest", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Low-to-High Cable Fly", muscle: "Chest", subTarget: "Upper Pec (Clavicular)", registryKey: "chest", hours: 36, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Flat Barbell Bench Press", muscle: "Chest", subTarget: "Mid/Lower Pec (Sternal)", registryKey: "chest", hours: 48, position: "Mid-Range", risk: "Moderate 🟡", tier: "A-Tier" },
  { name: "Flat Dumbbell Press", muscle: "Chest", subTarget: "Mid/Lower Pec (Sternal)", registryKey: "chest", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Pec Deck Fly (Machine)", muscle: "Chest", subTarget: "Mid/Lower Pec (Sternal)", registryKey: "chest", hours: 36, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Chest Dips", muscle: "Chest", subTarget: "Lower Pec (Costal)", registryKey: "chest", hours: 48, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "A-Tier" },
  { name: "Machine Chest Press", muscle: "Chest", subTarget: "Mid/Lower Pec (Sternal)", registryKey: "chest", hours: 48, position: "Mid-Range", risk: "Low 🟢", tier: "S-Tier" },

  // BACK & LATS
  { name: "Lat Pulldown (Wide/Neutral)", muscle: "Back", subTarget: "Lats (Vertical Pull)", registryKey: "upper_back", hours: 48, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Pull-ups / Weighted Chin-ups", muscle: "Back", subTarget: "Lats (Vertical Pull)", registryKey: "upper_back", hours: 48, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "S-Tier" },
  { name: "Single-Arm Lat Cable Row", muscle: "Back", subTarget: "Lats (Iliac / Lower)", registryKey: "upper_back", hours: 48, position: "Lengthened & Shortened", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Chest-Supported T-Bar Row", muscle: "Back", subTarget: "Upper Back / Rhomboids", registryKey: "trapezius_back", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Meadows Row", muscle: "Back", subTarget: "Upper Lats & Teres Major", registryKey: "upper_back", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Barbell Bent-Over Row", muscle: "Back", subTarget: "Upper Back / Lats", registryKey: "trapezius_back", hours: 48, position: "Mid-Range", risk: "High (Axial) 🔴", tier: "A-Tier" },
  { name: "Seated Cable Row (Wide)", muscle: "Back", subTarget: "Upper Back / Mid-Traps", registryKey: "trapezius_back", hours: 48, position: "Shortened (Peak)", risk: "Low 🟢", tier: "A-Tier" },
  { name: "Barbell Deadlift", muscle: "Back", subTarget: "Erectors / Posterior Chain", registryKey: "lower_back", hours: 72, position: "Mid-Range", risk: "High (Axial) 🔴", tier: "A-Tier" },
  { name: "Hyperextensions", muscle: "Back", subTarget: "Lower Back (Erectors)", registryKey: "lower_back", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "A-Tier" },

  // SHOULDERS
  { name: "Standing Overhead Press (OHP)", muscle: "Shoulders", subTarget: "Front Delt (Anterior)", registryKey: "deltoids", hours: 36, position: "Mid-Range", risk: "High (Axial) 🔴", tier: "A-Tier" },
  { name: "Seated Dumbbell Shoulder Press", muscle: "Shoulders", subTarget: "Front Delt (Anterior)", registryKey: "deltoids", hours: 36, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "A-Tier" },
  { name: "Cable Lateral Raise", muscle: "Shoulders", subTarget: "Side Delt (Lateral)", registryKey: "deltoids", hours: 24, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Cable Y-Raise", muscle: "Shoulders", subTarget: "Side Delt (Lateral)", registryKey: "deltoids", hours: 24, position: "Lengthened & Shortened", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Dumbbell Lateral Raise", muscle: "Shoulders", subTarget: "Side Delt (Lateral)", registryKey: "deltoids", hours: 24, position: "Shortened (Peak)", risk: "Low 🟢", tier: "A-Tier" },
  { name: "Machine Lateral Raise", muscle: "Shoulders", subTarget: "Side Delt (Lateral)", registryKey: "deltoids", hours: 24, position: "Lengthened & Shortened", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Face Pulls", muscle: "Shoulders", subTarget: "Rear Delt (Posterior)", registryKey: "deltoids_back", hours: 24, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Reverse Pec Deck", muscle: "Shoulders", subTarget: "Rear Delt (Posterior)", registryKey: "deltoids_back", hours: 24, position: "Lengthened & Shortened", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Incline Rear Delt DB Flyes", muscle: "Shoulders", subTarget: "Rear Delt (Posterior)", registryKey: "deltoids_back", hours: 24, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "A-Tier" },

  // ARMS
  { name: "Incline Dumbbell Curl", muscle: "Biceps", subTarget: "Long Head (Peak)", registryKey: "biceps", hours: 36, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Bayesian Cable Curl", muscle: "Biceps", subTarget: "Long Head (Peak)", registryKey: "biceps", hours: 36, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Preacher Curl (Machine/EZ)", muscle: "Biceps", subTarget: "Short Head (Inner)", registryKey: "biceps", hours: 36, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "A-Tier" },
  { name: "Hammer Curl (Dumbbell/Cable)", muscle: "Biceps", subTarget: "Brachialis & Forearms", registryKey: "biceps", hours: 24, position: "Mid-Range", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Overhead Dual Cable Extension", muscle: "Triceps", subTarget: "Long Head Triceps", registryKey: "triceps", hours: 36, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Incline EZ Skull Crushers", muscle: "Triceps", subTarget: "Long Head Triceps", registryKey: "triceps_back", hours: 48, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "A-Tier" },
  { name: "Cable Triceps Pushdown (Straight/V)", muscle: "Triceps", subTarget: "Lateral & Medial Head", registryKey: "triceps", hours: 36, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },

  // LEGS & LOWER BODY
  { name: "Barbell Back Squat", muscle: "Legs", subTarget: "Quads & Glutes", registryKey: "quadriceps", hours: 72, position: "Lengthened (Stretch)", risk: "High (Axial) 🔴", tier: "A-Tier" },
  { name: "Hack Squat", muscle: "Legs", subTarget: "Quads (Knee Extensors)", registryKey: "quadriceps", hours: 72, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Leg Press", muscle: "Legs", subTarget: "Quads & Adductors", registryKey: "quadriceps", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Leg Extensions", muscle: "Legs", subTarget: "Rectus Femoris", registryKey: "quadriceps", hours: 48, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Romanian Deadlift (DB/Barbell)", muscle: "Legs", subTarget: "Hamstrings (Lengthened)", registryKey: "hamstring", hours: 72, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "S-Tier" },
  { name: "Seated Leg Curl", muscle: "Legs", subTarget: "Hamstrings (Knee Flexion)", registryKey: "hamstring", hours: 48, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Bulgarian Split Squat", muscle: "Legs", subTarget: "Glutes & Quads", registryKey: "gluteal", hours: 48, position: "Lengthened (Stretch)", risk: "Moderate 🟡", tier: "S-Tier" },
  { name: "Barbell / Machine Hip Thrust", muscle: "Legs", subTarget: "Glutes (Maximus)", registryKey: "gluteal", hours: 48, position: "Shortened (Peak)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Standing Machine Calf Raise", muscle: "Legs", subTarget: "Calves (Gastrocnemius)", registryKey: "calves", hours: 24, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" },
  { name: "Seated Calf Raise Machine", muscle: "Legs", subTarget: "Calves (Soleus)", registryKey: "calves_back", hours: 24, position: "Lengthened (Stretch)", risk: "Low 🟢", tier: "S-Tier" }
];
...
// 3. MASTER STYLESHEET
// =============================================================
const rootContainer = dv.el("div", "", { cls: "master-tracker-root" });
...
styleSheet.textContent = `
    ...
    .wk-badge { background: #2563eb; color: #ffffff; font-size: 0.65rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em; padding: 4px 10px; border-radius: 999px; }
    .wk-live-duration { background: #0f172a; border: 1px solid #1e293b; color: #38bdf8; font-size: 0.8rem; font-weight: 800; padding: 4px 12px; border-radius: 8px; font-variant-numeric: tabular-nums; }
    ...
    .wk-timer-btn { background: #172554; border: 1px solid #2563eb; color: #93c5fd; padding: 6px 10px; border-radius: 8px; font-size: 0.72rem; font-weight: 700; cursor: pointer; }
    .wk-timer-btn:hover { background: #2563eb; color: white; }
    ...
    .wk-btn { flex: 1; background: #0f172a; color: #ffffff; border: 1px solid #1e293b; border-radius: 10px; padding: 10px; font-size: 0.82rem; font-weight: 700; cursor: pointer; text-align: center; transition: all 0.15s ease; }
    ...
    .wk-btn-new-session { width: 100%; background: #2563eb; color: #ffffff; border: none; border-radius: 10px; padding: 12px; font-weight: 800; font-size: 0.9rem; cursor: pointer; margin: 18px 0; }
    .wk-btn-new-session:hover { background: #1d4ed8; }

    /* =============================================================
       SEPARATE BOTTOM BODY HEATMAP STYLES (.bm3-root)
       ============================================================= */
    .bm3-root {
        background: radial-gradient(circle at 50% 0%, #131c2c 0%, #080b12 75%);
    ...
    .bm3-header { text-align: center; margin-bottom: 18px; }
    .bm3-title { font-size: 1.35rem; font-weight: 800; color: #f1f5f9; display: flex; align-items: center; justify-content: center; gap: 10px; }
    .bm3-title .bm3-icon { color: #38bdf8; }
    .bm3-subtitle { color: #64748b; font-size: 0.82rem; margin-top: 5px; }

    .bm3-viewtabs { display: flex; justify-content: center; gap: 6px; margin: 16px 0 10px; }
    .bm3-viewtab {
    ...
    .bm3-layout { display: flex; align-items: center; justify-content: center; gap: 16px; flex-wrap: wrap; padding: 6px 0; }
    .bm3-panel {
    ...
    .bm3-panel-title { font-size: 0.65rem; letter-spacing: 0.09em; color: #64748b; font-weight: 700; margin-bottom: 14px; }
    ...
    .bm3-howto-icon { width: 24px; height: 24px; border-radius: 8px; background: rgba(56,189,248,0.12); display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 0.8rem; }
    .bm3-howto-text { font-size: 0.74rem; color: #94a3b8; line-height: 1.3; }

    .bm3-viewport { position: relative; width: 230px; height: 460px; flex-shrink: 0; margin: 0 auto; }
    .bm3-vector-svg { width: 100%; height: 100%; filter: drop-shadow(0 16px 28px rgba(0,0,0,0.65)); overflow: visible; }
    ...
    .bm3-muscle-path:hover { filter: saturate(1.2) brightness(1.2) drop-shadow(0 0 9px currentColor); opacity: 1; }
    .bm3-muscle-path.selected { filter: saturate(1.3) brightness(1.32) drop-shadow(0 0 16px currentColor); opacity: 1; }
    .bm3-fiber-overlay { pointer-events: none; mix-blend-mode: overlay; opacity: 0.45; }
    ...
    .bm3-detail-hours { color: #38bdf8; font-size: 0.8rem; font-weight: 700; margin: 3px 0 6px; }
    .bm3-detail-desc { color: #94a3b8; font-size: 0.8rem; max-width: 500px; line-height: 1.35; }
    .bm3-detail-tag { padding: 8px 14px; border-radius: 8px; font-weight: 700; font-size: 0.78rem; color: #fff; white-space: nowrap; }
...
// =============================================================
// 4. HEAT COLOR ENGINE & COMPONENT BUILDER
// =============================================================
const HEAT_TIERS = {
    fresh:    { base: "#22c55e", light: "#a7f3c8", dark: "#0f2e1c", label: "Rest / Fresh (0h)" },
    low:      { base: "#eab308", light: "#fde68a", dark: "#3f2f08", label: "Mild Fatigue (~24h)" },
    moderate: { base: "#f97316", light: "#fdc493", dark: "#3f200a", label: "Moderate Soreness (~48h)" },
    high:     { base: "#ef4444", light: "#fca5a5", dark: "#3f1212", label: "High Soreness (~72h)" },
};
...
function mountSeparateBodyHeatmap(parentEl, soreMap = {}, isPostWorkout = false) {
    const INSTANCE_ID = Math.random().toString(36).slice(2, 8);
    const registry = JSON.parse(JSON.stringify(rawMuscleRegistry));

    // Configure fatigue status: All at rest before workout; mapped soreness after workout
    Object.keys(registry).forEach(key => {
        if (isPostWorkout && soreMap[key]) {
            registry[key].recovery = soreMap[key].recoveryScore || 20;
            registry[key].recoveryHours = soreMap[key].hours || 48;
            registry[key].sessionImpact = soreMap[key].reason || "Fatigued from workout sets";
        } else {
            registry[key].recovery = 100; // All At Rest
            registry[key].recoveryHours = 0;
            registry[key].sessionImpact = "Muscle fully rested and primed for exertion.";
        }
    });

    const root = parentEl.createDiv({ cls: "bm3-root" });
    let currentView = "front";
    let selectedKey = null;
    let selectedPoint = null;

    // Header
    const header = root.createDiv({ cls: "bm3-header" });
    header.createDiv({ cls: "bm3-title" }).innerHTML = `<span class="bm3-icon">⬡</span> Anatomical Musculoskeletal Heatmap`;
    header.createDiv({
        cls: "bm3-subtitle",
        text: isPostWorkout 
            ? "Post-Workout Recovery Status • Click any highlighted muscle to inspect soreness window" 
            : "Pre-Workout Base Status • All muscle systems at full rest"
    });

    // Viewtabs
    const viewTabs = root.createDiv({ cls: "bm3-viewtabs" });
    ...
    // Layout
    const layout = root.createDiv({ cls: "bm3-layout" });

    // Legend
    const legendPanel = layout.createDiv({ cls: "bm3-panel" });
    legendPanel.createDiv({ cls: "bm3-panel-title", text: "RECOVERY TIER" });
    [
        { color: "#22c55e", label: "Fresh", sub: "(At Rest / Ready)" },
        { color: "#eab308", label: "Low", sub: "(~24h Recovery)" },
        { color: "#f97316", label: "Moderate", sub: "(~48h Recovery)" },
        { color: "#ef4444", label: "High", sub: "(~72h Recovery)" }
    ].forEach(item => {
    ...
    howtoPanel.createDiv({ cls: "bm3-panel-title", text: "HEATMAP HUD" });
    [
        { icon: "⚡", text: isPostWorkout ? "Sore muscles rendered in warm spectrum" : "All muscle groups at baseline rest" },
        { icon: "🖱️", text: "Click or hover any muscle for recovery time" },
        { icon: "🔁", text: "Toggle FRONT / BACK for posterior chain" }
    ].forEach(item => {
    ...
    // Detail Card
    const detailCard = root.createDiv({ cls: "bm3-detail-card" });
    ...
    function renderDetails(key) {
        ...
        if (model.recoveryHours > 0) {
            detailHours.innerHTML = `⏱️ <b>${model.recoveryHours} Hours</b> Remaining Recovery Window`;
            detailDesc.setText(model.sessionImpact || model.desc);
            detailTag.setText(tier.label);
        } else {
            detailHours.innerHTML = `🟢 <b>Fully Recovered</b> (0 Hours Remaining)`;
            detailDesc.setText(model.sessionImpact || "At baseline rest. Ready for direct hypertrophic training.");
            detailTag.setText("Ready / Fresh");
        }
        ...
        for (const [key, item] of Object.entries(registry)) {
            ...
            defs += `
                <pattern id="${pid}" width="5" height="5" patternTransform="rotate(58)" patternUnits="userSpaceOnUse">
                    ...
                    <line x1="0" y1="0" x2="0" y2="5" stroke="#000000" stroke-width="0.8" stroke-opacity="0.7" />
                    <line x1="2.5" y1="0" x2="2.5" y2="5" stroke="#ffffff" stroke-width="0.5" stroke-opacity="0.3" />
                </pattern>
            `;
        }
        return defs;
    ...
    function showAnnotation(svgEl, view, point, label) {
        const prev = svgEl.querySelector(".bm3-annot-group");
        if (prev) prev.remove();
        ...
        const targetX = routeLeft ? Math.max(vbX + 14, cx - 56) : Math.min(vbX + vbWidth - 14, cx + 56);
        const textAnchor = routeLeft ? "end" : "start";
        const textX = targetX + (routeLeft ? -12 : 12);
        const textLength = label.length * 14;
        const backdropX = routeLeft ? textX - textLength - 8 : textX - 8;

        const html = `
            <g class="bm3-annot-group">
                <line x1="${cx}" y1="${cy}" x2="${targetX}" y2="${cy}" stroke="#38bdf8" stroke-width="4" stroke-linecap="round" />
                <circle cx="${cx}" cy="${cy}" r="9" fill="#38bdf8" stroke="#0b1220" stroke-width="3" />
                <rect class="bm3-annot-backdrop" x="${backdropX}" y="${cy - 18}" width="${textLength + 16}" height="36" />
                <text x="${textX}" y="${cy}" fill="#f8fafc" font-size="28" font-weight="800" text-anchor="${textAnchor}" dominant-baseline="middle" style="paint-order: stroke; stroke: #0b1220; stroke-width: 6px; stroke-linejoin: round;">${label}</text>
            </g>
        `;
    ...
    function renderBody(view) {
        ...
        for (const [key, item] of Object.entries(registry)) {
            ...
            pathsHtml += `<g class="bm3-muscle-group">`;
        ...
        if (selectedKey && selectedPoint && registry[selectedKey] && registry[selectedKey].view === view) {
            showAnnotation(svgEl, view, selectedPoint, registry[selectedKey].name);
        }
    }
    ...
    function switchView(view) {
        ...
        renderBody(view);
        const firstKey = Object.keys(registry).find(k => registry[k].view === view);
    ...
    renderBody("front");
    const initKey = isPostWorkout ? (Object.keys(soreMap)[0] || "chest") : "chest";
    renderDetails(registry[initKey] ? initKey : "chest");
}

// =============================================================
// 5. SESSION STATE & RUNTIME HELPERS
// =============================================================
let savedRecap = null;
try {
...
// =============================================================
// 6. FINISHED RECAP SCREEN (WITH POST-WORKOUT BODY SORENESS)
// =============================================================
function renderFinishedScreen(data) {
  if (durationInterval) clearInterval(durationInterval);
  rootContainer.empty();

  const appEl = rootContainer.createDiv({ cls: "wk-app" });
  let cardsHtml = "";
  const soreMuscles = {};
  ...
  data.exercises.forEach(ex => {
    ...
    // Register soreness for body map
    if (info.registryKey) {
      soreMuscles[info.registryKey] = {
        hours: info.hours || 48,
        recoveryScore: (info.hours >= 72) ? 15 : ((info.hours >= 48) ? 30 : 50),
        reason: `Targeted via ${ex.name} (${info.subTarget || ex.muscle}). Full hypertrophy strain applied.`
      };
    }
  ...
  appEl.innerHTML = `
    <div class="wk-recap-screen">
      <div class="wk-recap-head">
        ...
        <h2 class="wk-recap-title">Workout Summary & Recovery HUD</h2>
        <div style="font-size:0.8rem; color:#94a3b8; margin-top:4px;">Session logged successfully. Body map updated with recovery timers below.</div>
      </div>
      <div class="wk-stats-grid">
        <div class="wk-stat-box"><div class="wk-stat-lbl">Duration</div><div class="wk-stat-val" style="color:#a7f3d0;">${data.durationFormatted}</div></div>
  ...
  appEl.querySelector("#btn-start-new").onclick = () => {
    try {
  ...
  // MOUNT BODY MAP SEPARATELY AT THE VERY BOTTOM (SHOWING POST-WORKOUT SORENESS)
  mountSeparateBodyHeatmap(rootContainer, soreMuscles, true);
}

// =============================================================
// 7. ACTIVE WORKOUT APP (BODY MAP AT BOTTOM SHOWS REST)
// =============================================================
function initActiveApp() {
  ...
  appEl.innerHTML = `
    <div class="wk-topbar">
      <div>
        ...
        <h3 style="margin:4px 0 0 0; font-size:1.25rem; font-weight:800;">Active Workout Session</h3>
      </div>
  ...
  const liveDurationEl = appEl.querySelector("#live-session-time");
  ...
  const cardsContainer = appEl.querySelector("#cards-container");
  const timerDisplay = appEl.querySelector("#timer-val");
  const timerRing = appEl.querySelector("#timer-ring-circle");
  ...
  appEl.querySelector("#t-60").onclick = () => startRestTimer(60);
  appEl.querySelector("#t-90").onclick = () => startRestTimer(90);
  appEl.querySelector("#t-reset").onclick = () => {
    clearInterval(timerInterval);
    timerSeconds = 0;
    updateTimerUI();
  };

  const addSelector = appEl.querySelector("#add-selector");
  const routineSelector = appEl.querySelector("#routine-selector");
  const searchBox = appEl.querySelector("#search-box");
  const searchList = appEl.querySelector("#search-list");
  ...
  appEl.querySelector("#btn-open-add").onclick = () => {
  ...
  appEl.querySelector("#btn-ex-cancel").onclick = () => addSelector.style.display = "none";

  appEl.querySelector("#btn-routine").onclick = () => {
    addSelector.style.display = "none";
    routineSelector.style.display = "block";
  };
  appEl.querySelector("#btn-split-cancel").onclick = () => routineSelector.style.display = "none";

  appEl.querySelector("#btn-split-load").onclick = () => {
    const selected = appEl.querySelector("#split-select").value;
  ...
  function updateGapAndRedundancy() {
    const gapBanner = appEl.querySelector("#gap-banner");
  ...
  function updateStats() {
    ...
    appEl.querySelector("#stat-cals").textContent = cals + " kcal";
    appEl.querySelector("#stat-vol").textContent = totalVol.toLocaleString();
    appEl.querySelector("#stat-sets").textContent = String(totalSets);
    appEl.querySelector("#stat-ex").textContent = String(sessionExercises.length);
  }

  const plateModal = appEl.querySelector("#plate-popover");
  const plateRender = appEl.querySelector("#plate-bar-render");
  const plateList = appEl.querySelector("#plate-breakdown-list");
  const plateText = appEl.querySelector("#plate-popover-text");
  appEl.querySelector("#btn-close-plate").onclick = () => plateModal.style.display = "none";
  ...
  function attachEvents() {
    appEl.querySelectorAll(".set-weight").forEach(inp => {
      inp.oninput = e => {
    ...
    appEl.querySelectorAll(".set-reps").forEach(inp => {
      inp.oninput = e => {
    ...
    appEl.querySelectorAll(".btn-del-set").forEach(btn => {
      btn.onclick = () => {
    ...
    appEl.querySelectorAll(".btn-add-set").forEach(btn => {
      btn.onclick = () => {
    ...
    appEl.querySelectorAll(".btn-del-card").forEach(btn => {
      btn.onclick = () => {
  ...
  appEl.querySelector("#btn-save-note").onclick = async () => {
  ...
  // MOUNT BODY MAP SEPARATELY AT THE BOTTOM (ALL MUSCLES RESTING BEFORE COMPLETION)
  mountSeparateBodyHeatmap(rootContainer, {}, false);
}
